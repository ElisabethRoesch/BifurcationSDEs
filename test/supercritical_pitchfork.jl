...
file_path_raw = "test/data/rep_output_supercritical_raw.jld"
file_path_potential = "test/data/rep_output_supercritical_potential.jld"
...
ps_potential = plot_potentials(rep_output_potential, test_list_alpha, test_list_sigma, 1, length(test_list_alpha), 1, 4, cols, alphas_col)
    ...
    savefig("test/plots/supercritical_pitchfork_summary_plot_2_potential.pdf")
...
ps_raw = plot_raw_data(rep_output_raw, test_list_alpha, test_list_sigma, 1, length(test_list_alpha), 1, 4, cols, alphas_col)
    ...
    savefig("test/plots/supercritical_pitchfork_summary_plot_2_raw.pdf")
